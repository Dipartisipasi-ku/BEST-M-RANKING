-- ============================================================================
-- SUPABASE SCHEMA: EVALUASI KEPATUHAN & DISIPLIN PEGAWAI RUMAH SAKIT
...
CREATE POLICY "Audit: Komite Mutu & Super Admin can view logs"
  ON public.evaluation_audit_logs FOR SELECT USING (public.is_komite_mutu());

CREATE POLICY "Audit: System can insert logs"
  ON public.evaluation_audit_logs FOR INSERT WITH CHECK (true);
...
-- ============================================================================
-- 7. TABEL & REKONSILIASI: PUBLIC.MASTER (SKEMA RESMI RUMAH SAKIT)
-- ============================================================================
...
-- ============================================================================
-- 8. QUERY ALTER TABLE REKONSILIASI DATABASE LIVE EVALUATION_RECORDS
-- ============================================================================

-- Tambahkan kolom pin_atribut_logo jika tabel evaluation_records dibuat dari versi lama
DO $$ 
BEGIN 
...
-- Tambahkan kolom Timestamp kompatibel Google Form
ALTER TABLE public.evaluation_records 
  ADD COLUMN IF NOT EXISTS "Timestamp" time without time zone DEFAULT CURRENT_TIME;

-- Longgarkan constraint unit_id agar sinkronisasi dari master tidak gagal akibat foreign key
ALTER TABLE public.evaluation_records 
